...
export const episodes: Episode[] = [
  {
    ...
    dischargeDate: "2026-02-26", facility: "University Hospital", sla48hDue: "2026-02-28T17:00:00",
    status: "ACTIVE",
    steps: [
      { key: "enroll", label: "Enroll in TOC", status: "DONE", due: null },
      { key: "interactive_contact", label: "Interactive Contact", status: "OPEN", due: "2026-02-28T17:00:00" },
      { key: "med_reconciliation", label: "Medication Reconciliation", status: "OPEN", due: null },
      { key: "pcp_followup", label: "Schedule PCP Follow-up", status: "OPEN", due: null },
      { key: "weekly_followups", label: "Weekly Follow-ups", status: "OPEN", due: null },
    ],
  },
  {
    id: "e_3002", patientId: "p_1003", type: "TOC", startDate: "2026-02-20",
    dischargeDate: "2026-02-22", facility: "St. Mary's Medical Center", sla48hDue: "2026-02-24T17:00:00",
    status: "ACTIVE",
    steps: [
      { key: "enroll", label: "Enroll in TOC", status: "DONE", due: null },
      { key: "interactive_contact", label: "Interactive Contact", status: "DONE", due: "2026-02-24T17:00:00" },
      { key: "med_reconciliation", label: "Medication Reconciliation", status: "DONE", due: null },
      { key: "pcp_followup", label: "Schedule PCP Follow-up", status: "OPEN", due: null },
      { key: "weekly_followups", label: "Weekly Follow-ups", status: "OPEN", due: null },
    ],
  },
  {
    ...
    dischargeDate: "2026-02-28", facility: "General Hospital", sla48hDue: "2026-03-02T17:00:00",
    status: "ACTIVE",
    steps: [
      { key: "enroll", label: "Enroll in TOC", status: "OPEN", due: null },
      { key: "interactive_contact", label: "Interactive Contact", status: "OPEN", due: "2026-03-02T17:00:00" },
      { key: "med_reconciliation", label: "Medication Reconciliation", status: "OPEN", due: null },
      { key: "pcp_followup", label: "Schedule PCP Follow-up", status: "OPEN", due: null },
      { key: "weekly_followups", label: "Weekly Follow-ups", status: "OPEN", due: null },
    ],
  },
  {
    ...
    dischargeDate: "2026-02-25", facility: "University Hospital", sla48hDue: "2026-02-27T17:00:00",
    status: "ACTIVE",
    steps: [
      { key: "enroll", label: "Enroll in TOC", status: "DONE", due: null },
      { key: "interactive_contact", label: "Interactive Contact", status: "DONE", due: "2026-02-27T17:00:00" },
      { key: "med_reconciliation", label: "Medication Reconciliation", status: "DONE", due: null },
      { key: "pcp_followup", label: "Schedule PCP Follow-up", status: "DONE", due: null },
      { key: "weekly_followups", label: "Weekly Follow-ups", status: "OPEN", due: null },
    ],
  },
];
